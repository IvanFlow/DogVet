    ...
    public static class SeedDataExtension
    {
        ...
        private static List<Pet> SeedPets(DogVetContext context, List<Owner> owners, DateTime seedDate)
        {
            var pets = new List<Pet>
            {
                ...
                new Pet { Name = "Rocky", Breed = "German Shepherd", Weight = 35.2, Color = "Negro y café", Gender = "Macho", DateOfBirth = new DateTime(2022, 1, 20, 0, 0, 0, DateTimeKind.Utc), Species = Species.Dog.ToString(), IsActive = true, Owner = owners[0], CreatedAt = seedDate, UpdatedAt = seedDate },
                ...
                new Pet { Name = "Thor", Breed = "Pastor Alemán", Weight = 35.2, Color = "Negro con café", Gender = "Macho", DateOfBirth = new DateTime(2022, 9, 1, 0, 0, 0, DateTimeKind.Utc), Species = Species.Dog.ToString(), IsActive = false, Owner = owners[4], CreatedAt = seedDate, UpdatedAt = seedDate },
                ...
                new Pet { Name = "Gordo", Breed = "Bulldog Inglés", Weight = 28.0, Color = "Bayo", Gender = "Macho", DateOfBirth = new DateTime(2023, 5, 12, 0, 0, 0, DateTimeKind.Utc), Species = Species.Dog.ToString(), IsActive = true, Owner = owners[5], CreatedAt = seedDate, UpdatedAt = seedDate },
                ...
                new Pet { Name = "Laila", Breed = "Dachshund", Weight = 6.5, Color = "Café oscuro", Gender = "Hembra", DateOfBirth = new DateTime(2023, 9, 14, 0, 0, 0, DateTimeKind.Utc), Species = Species.Dog.ToString(), IsActive = true, Owner = owners[6], CreatedAt = seedDate, UpdatedAt = seedDate },
                
                // Patricia Ruiz (owner[7]) - 1 pet
                new Pet { Name = "Toby", Breed = "Jack Russell Terrier", Weight = 6.2, Color = "Blanco con café", Gender = "Macho", DateOfBirth = new DateTime(2024, 10, 8, 0, 0, 0, DateTimeKind.Utc), Species = Species.Dog.ToString(), IsActive = true, Owner = owners[7], CreatedAt = seedDate, UpdatedAt = seedDate },
                ...
                new Pet { Name = "Duke", Breed = "Mastiff", Weight = 55.0, Color = "Café claro", Gender = "Macho", DateOfBirth = new DateTime(2020, 5, 27, 0, 0, 0, DateTimeKind.Utc), Species = Species.Dog.ToString(), IsActive = true, Owner = owners[8], CreatedAt = seedDate, UpdatedAt = seedDate },
                ...
                new Pet { Name = "Simba", Breed = "Cocker Spaniel", Weight = 16.0, Color = "Café y blanco", Gender = "Macho", DateOfBirth = new DateTime(2022, 12, 10, 0, 0, 0, DateTimeKind.Utc), Species = Species.Dog.ToString(), IsActive = true, Owner = owners[9], CreatedAt = seedDate, UpdatedAt = seedDate }
            };
        ...
        /// </summary>
        private static List<MedicalHistory> SeedMedicalHistories(DogVetContext context, List<Pet> pets, List<Veterinarian> veterinarians, DateTime seedDate, DateTime today)
        {
            ...
            var histories = new List<MedicalHistory>
            {
                ...
                new MedicalHistory { Diagnosis = "Revisión general anual con vacunación", Notes = "Signos vitales normales, vacunas DHPP y antirrábica al día. Peso adecuado.", VisitDate = visitPast10, FollowUpDate = null, Status = "Completed", Pet = pets[0], Veterinarian = veterinarians[0], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Limpieza dental preventiva", Notes = "Acumulación leve de sarro, detartraje realizado sin complicaciones", VisitDate = visitPast30, FollowUpDate = followUpFuture120, Status = "Completed", Pet = pets[0], Veterinarian = veterinarians[1], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Otitis externa bilateral", Notes = "Infecciones de oído relacionadas con alergias. Gotas y medicamento oral prescritos.", VisitDate = visitPast20, FollowUpDate = followUpOverdue20, Status = "Follow-up", Pet = pets[0], Veterinarian = veterinarians[2], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Revisión de seguimiento - otitis", Notes = "infección mejorando con tratamiento. Continuar gotas por una semana más.", VisitDate = visitPast5, FollowUpDate = null, Status = "Completed", Pet = pets[0], Veterinarian = veterinarians[2], CreatedAt = seedDate, UpdatedAt = seedDate },
                
                // Bella (pets[1]) - Labrador
                new MedicalHistory { Diagnosis = "vacunación de rutina para cachorra", Notes = "Primera dosis de DHPP aplicada. Revisar en 3-4 semanas para refuerzo.", VisitDate = visitPast120, FollowUpDate = visitPast90, Status = "Completed", Pet = pets[1], Veterinarian = veterinarians[1], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Refuerzo de vacuna DHPP", Notes = "Segunda dosis de DHPP aplicada correctamente. Será revacunada en 1 año.", VisitDate = visitPast90, FollowUpDate = null, Status = "Completed", Pet = pets[1], Veterinarian = veterinarians[1], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Alergia alimentaria con dermatitis", Notes = "Cambio de dieta recomendado. Medicamento antihistamínico prescrito.", VisitDate = visitPast45, FollowUpDate = followUpNext25, Status = "Follow-up", Pet = pets[1], Veterinarian = veterinarians[0], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Revisión de seguimiento nutrición", Notes = "Se evalúa respuesta al nuevo alimento. Mejora notoria en condición de piel.", VisitDate = visitPast15, FollowUpDate = null, Status = "Completed", Pet = pets[1], Veterinarian = veterinarians[0], CreatedAt = seedDate, UpdatedAt = seedDate },
                
                // Rocky (pets[2]) - German Shepherd
                new MedicalHistory { Diagnosis = "Displasia de cadera - evaluación radiológica", Notes = "Radiografías realizadas. Grado moderado de displasia. Fisioterapia recomendada.", VisitDate = visitPast60, FollowUpDate = followUpFuture75, Status = "Follow-up", Pet = pets[2], Veterinarian = veterinarians[2], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Control de peso y condición muscular", Notes = "Reducción de actividad debido a displasia. Dieta especial iniciada.", VisitDate = visitPast10, FollowUpDate = null, Status = "Completed", Pet = pets[2], Veterinarian = veterinarians[0], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Revisión anual con pruebas de sangre", Notes = "Análisis completo realizado. Resultados dentro de parámetros normales.", VisitDate = visitPast5, FollowUpDate = null, Status = "Completed", Pet = pets[2], Veterinarian = veterinarians[1], CreatedAt = seedDate, UpdatedAt = seedDate },
                
                // Negra (pets[3]) - Poodle Negro
                new MedicalHistory { Diagnosis = "Otitis externa con infección bacteriana", Notes = "Cultivo realizado. Gotas antibacterianas prescritas. Control en 2 semanas.", VisitDate = visitPast15, FollowUpDate = followUpNext20, Status = "Follow-up", Pet = pets[3], Veterinarian = veterinarians[2], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Revisión de seguimiento - otitis control", Notes = "infección controlada con gotas. Continuar tratamiento 7 días más.", VisitDate = visitPast10, FollowUpDate = null, Status = "Completed", Pet = pets[3], Veterinarian = veterinarians[2], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Limpieza de oidos y Revisión dental", Notes = "Higiene correcta. Se recomienda limpieza semanal de oídos.", VisitDate = visitPast25, FollowUpDate = null, Status = "Completed", Pet = pets[3], Veterinarian = veterinarians[1], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Revisión pre-grooming y vacunación", Notes = "Estado general excelente. Vacuna antirrábica aplicada.", VisitDate = visitPast45, FollowUpDate = null, Status = "Completed", Pet = pets[3], Veterinarian = veterinarians[0], CreatedAt = seedDate, UpdatedAt = seedDate },
                
                // Max (pets[4]) - Boxer
                new MedicalHistory { Diagnosis = "Displasia de cadera leve", Notes = "Radiografías muestran displasia leve. Seguimiento clínico recomendado.", VisitDate = visitPast60, FollowUpDate = followUpNext20, Status = "Follow-up", Pet = pets[4], Veterinarian = veterinarians[2], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Control articular y evaluación de dolor", Notes = "Sin evidencia de dolor. Peso adecuado. Suplemento articular iniciado.", VisitDate = visitPast10, FollowUpDate = null, Status = "Completed", Pet = pets[4], Veterinarian = veterinarians[0], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Vacuna antirrábica de refuerzo", Notes = "Refuerzo aplicado sin complicaciones.", VisitDate = visitPast30, FollowUpDate = null, Status = "Completed", Pet = pets[4], Veterinarian = veterinarians[1], CreatedAt = seedDate, UpdatedAt = seedDate },
                
                // Titan (pets[5]) - Beagle
                new MedicalHistory { Diagnosis = "Otitis media recurrente", Notes = "Historial de infecciones de oído. evaluación auditiva recomendada.", VisitDate = visitPast25, FollowUpDate = followUpNext15, Status = "Follow-up", Pet = pets[5], Veterinarian = veterinarians[3], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Limpieza dental - eliminación de cálculo", Notes = "Detartraje completo realizado. Higiene oral deficiente. Cepillado diario recomendado.", VisitDate = visitPast45, FollowUpDate = followUpFuture90, Status = "Completed", Pet = pets[5], Veterinarian = veterinarians[2], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Revisión geriátrica completa", Notes = "Perro adulto mayor evaluado. Signos vitales estables. Seguimiento preventivo recomendado.", VisitDate = visitPast15, FollowUpDate = followUpFuture120, Status = "Completed", Pet = pets[5], Veterinarian = veterinarians[0], CreatedAt = seedDate, UpdatedAt = seedDate },
                
                // Luna (pets[6]) - Cocker Spaniel
                new MedicalHistory { Diagnosis = "Queratitis ulcerativa en ojo derecho", Notes = "úlcera corneal superficial. Lubricantes oftálmicos y antibióticos prescritos.", VisitDate = visitPast30, FollowUpDate = visitPast20, Status = "Completed", Pet = pets[6], Veterinarian = veterinarians[2], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Revisión oftalmológica post-tratamiento", Notes = "úlcera cicatrizada completamente. Visión recuperada.", VisitDate = visitPast25, FollowUpDate = null, Status = "Completed", Pet = pets[6], Veterinarian = veterinarians[2], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "vacunación de rutina", Notes = "Vacunas DHPP y antirrábica aplicadas. Presencia de ectoparásitos detectada.", VisitDate = visitPast10, FollowUpDate = followUpNext10, Status = "Follow-up", Pet = pets[6], Veterinarian = veterinarians[1], CreatedAt = seedDate, UpdatedAt = seedDate },
                
                // Charlie (pets[7]) - Schnauzer
                new MedicalHistory { Diagnosis = "desparasitación cachorro - interna y externa", Notes = "Parásitos internos detectados en Análisis fecal. Tratamiento completo iniciado.", VisitDate = visitPast90, FollowUpDate = visitPast75, Status = "Completed", Pet = pets[7], Veterinarian = veterinarians[0], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Refuerzo de desparasitación", Notes = "Análisis fecal repetido. Control negativo. Cachorro en buena salud.", VisitDate = visitPast75, FollowUpDate = null, Status = "Completed", Pet = pets[7], Veterinarian = veterinarians[0], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "vacunación primaria - DHPP", Notes = "Primera dosis de vacuna polivalente aplicada correctamente.", VisitDate = visitPast85, FollowUpDate = visitPast65, Status = "Completed", Pet = pets[7], Veterinarian = veterinarians[1], CreatedAt = seedDate, UpdatedAt = seedDate },
                
                // Princesa (pets[8]) - Shih Tzu
                new MedicalHistory { Diagnosis = "Conjuntivitis alérgica bilateral", Notes = "Inflamación leve de conjuntivas. Gotas oftálmicas y antihistamínico prescrito.", VisitDate = visitPast20, FollowUpDate = followUpOverdue15, Status = "Follow-up", Pet = pets[8], Veterinarian = veterinarians[2], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Limpieza de oídos preventiva", Notes = "Orejas largas propensas a infecciones. Limpieza completa realizada.", VisitDate = visitPast40, FollowUpDate = followUpFuture75, Status = "Completed", Pet = pets[8], Veterinarian = veterinarians[0], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "vacunación de cachorra", Notes = "DHPP y antirrábica iniciadas. Cachorrita pequeña pero saludable.", VisitDate = visitPast70, FollowUpDate = visitPast50, Status = "Completed", Pet = pets[8], Veterinarian = veterinarians[1], CreatedAt = seedDate, UpdatedAt = seedDate },
                ...
                new MedicalHistory { Diagnosis = "evaluación geriátrica integral", Notes = "Perro adulto mayor con movilidad reducida. Calidad de vida evaluada.", VisitDate = visitPast90, FollowUpDate = null, Status = "Completed", Pet = pets[9], Veterinarian = veterinarians[2], CreatedAt = seedDate, UpdatedAt = seedDate },
                
                // Nala (pets[10]) - Husky
                new MedicalHistory { Diagnosis = "Alopecia estacional seasonal", Notes = "Caída excesiva de pelo típica de la raza. Suplemento de ácidos grasos prescrito.", VisitDate = visitPast25, FollowUpDate = followUpFuture120, Status = "Completed", Pet = pets[10], Veterinarian = veterinarians[0], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Revisión post-muda", Notes = "Muda completada. Pelaje en excelente condición. Recomendación de cepillado frecuente mantenida.", VisitDate = visitPast10, FollowUpDate = null, Status = "Completed", Pet = pets[10], Veterinarian = veterinarians[1], CreatedAt = seedDate, UpdatedAt = seedDate },
                ...
                new MedicalHistory { Diagnosis = "evaluación pre-quirurgica", Notes = "Análisis de sangre y Radiografías completadas. Apto para Cirugía.", VisitDate = visitPast50, FollowUpDate = null, Status = "Completed", Pet = pets[11], Veterinarian = veterinarians[2], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Control de peso y dieta", Notes = "Sobrepeso leve detectado. Dieta baja en calorías recomendada.", VisitDate = visitPast8, FollowUpDate = followUpFuture90, Status = "Completed", Pet = pets[11], Veterinarian = veterinarians[0], CreatedAt = seedDate, UpdatedAt = seedDate },
                
                // Mimi (pets[12]) - Maltesa
                new MedicalHistory { Diagnosis = "Calculus dental y enfermedad periodontal", Notes = "Acumulación severa de sarro. Limpieza dental urgente recomendada.", VisitDate = visitPast12, FollowUpDate = followUpOverdue10, Status = "Follow-up", Pet = pets[12], Veterinarian = veterinarians[2], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Revisión rutinaria con vacunación", Notes = "Signos vitales normales. DHPP y antirrábica aplicadas.", VisitDate = visitPast50, FollowUpDate = null, Status = "Completed", Pet = pets[12], Veterinarian = veterinarians[1], CreatedAt = seedDate, UpdatedAt = seedDate },
                ...
                new MedicalHistory { Diagnosis = "Control cardíaco - evaluación de medicamentos", Notes = "Frecuencia cardíaca mejorando con tratamiento. Continuación de fármacos indicada.", VisitDate = visitPast8, FollowUpDate = null, Status = "Completed", Pet = pets[13], Veterinarian = veterinarians[4], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Revisión anual de rutina", Notes = "Dieta cardíaca y medicamentos continuados. Estado general estable.", VisitDate = visitPast30, FollowUpDate = null, Status = "Completed", Pet = pets[13], Veterinarian = veterinarians[0], CreatedAt = seedDate, UpdatedAt = seedDate },
                
                // Coco (pets[14]) - Pug
                new MedicalHistory { Diagnosis = "Obesidad - plan de Pérdida de peso", Notes = "Sobrepeso severo. Dieta restrictiva calórica iniciada. Ejercicio progresivo recomendado.", VisitDate = visitPast28, FollowUpDate = followUpNext12, Status = "Follow-up", Pet = pets[14], Veterinarian = veterinarians[0], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Revisión oftalmológica preventiva", Notes = "Ojos prominentes evaluados. Sin úlceras detectadas. Limpieza de arrugas realizada.", VisitDate = visitPast35, FollowUpDate = null, Status = "Completed", Pet = pets[14], Veterinarian = veterinarians[2], CreatedAt = seedDate, UpdatedAt = seedDate },
                
                // Laila (pets[15]) - Dachshund
                new MedicalHistory { Diagnosis = "Parálisis lumbar - disco intervertebral herniad", Notes = "Pérdida parcial de movilidad trasera. Medicamentos y reposo prescrito.", VisitDate = visitPast75, FollowUpDate = followUpOverdue30, Status = "Follow-up", Pet = pets[15], Veterinarian = veterinarians[4], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "evaluación de recuperación neuromuscular", Notes = "Mejora leve en movilidad. Fisioterapia continuada recomendada.", VisitDate = visitPast5, FollowUpDate = null, Status = "Completed", Pet = pets[15], Veterinarian = veterinarians[4], CreatedAt = seedDate, UpdatedAt = seedDate },
                
                // Toby (pets[16]) - Jack Russell Terrier
                new MedicalHistory { Diagnosis = "Luxación patelar unilateral grado II", Notes = "Rótula dislocada ocasionalmente. Seguimiento clínico recomendado. Cirugía evaluada.", VisitDate = visitPast55, FollowUpDate = followUpFuture90, Status = "Completed", Pet = pets[16], Veterinarian = veterinarians[2], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Revisión post-control - comportamiento y movilidad", Notes = "Perro activo. Sin síntomas agudos. Observación continuada recomendada.", VisitDate = visitPast8, FollowUpDate = null, Status = "Completed", Pet = pets[16], Veterinarian = veterinarians[1], CreatedAt = seedDate, UpdatedAt = seedDate },
                
                // Fido (pets[17]) - Rottweiler
                new MedicalHistory { Diagnosis = "Gastroenteritis aguda - vómitos y diarrea", Notes = "Probable intoxicación alimentaria. Fluidoterapia y medicamentos antiemético prescritos.", VisitDate = visitPast15, FollowUpDate = followUpNext18, Status = "Follow-up", Pet = pets[17], Veterinarian = veterinarians[0], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Revisión post-gastroenteritis", Notes = "recuperación completa. Digestión normalizada. Dieta blanda continuada 3 días más.", VisitDate = visitPast10, FollowUpDate = null, Status = "Completed", Pet = pets[17], Veterinarian = veterinarians[0], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Revisión anual de rutina", Notes = "Signos vitales normales. Vacunaciones al día. Peso adecuado.", VisitDate = visitPast35, FollowUpDate = null, Status = "Completed", Pet = pets[17], Veterinarian = veterinarians[1], CreatedAt = seedDate, UpdatedAt = seedDate },
                
                // Daisy (pets[18]) - Miniature Pinscher
                new MedicalHistory { Diagnosis = "vacunación de cachorra - serie primaria", Notes = "Primera dosis DHPP y antirrábica aplicadas sin reacción.", VisitDate = visitPast120, FollowUpDate = visitPast105, Status = "Completed", Pet = pets[18], Veterinarian = veterinarians[1], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Refuerzo de vacunación", Notes = "Segunda dosis DHPP aplicada. Tercera dosis en 3-4 semanas.", VisitDate = visitPast105, FollowUpDate = visitPast90, Status = "Completed", Pet = pets[18], Veterinarian = veterinarians[1], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Caída de diente de cachorro - erupción normal", Notes = "Cambio adeacuado de dentición. Sin retención de dientes deciduos.", VisitDate = visitPast65, FollowUpDate = null, Status = "Completed", Pet = pets[18], Veterinarian = veterinarians[2], CreatedAt = seedDate, UpdatedAt = seedDate },
                
                // Duke (pets[19]) - Mastiff
                new MedicalHistory { Diagnosis = "Artritis degenerativa - etapa avanzada", Notes = "Movilidad limitada. Medicamentos para dolor y condroprotectores prescritos.", VisitDate = visitPast100, FollowUpDate = followUpNext5, Status = "Follow-up", Pet = pets[19], Veterinarian = veterinarians[4], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "evaluación de calidad de vida - perro geriátrico", Notes = "Confort y medicación evaluados. Cama ortopédica recomendada.", VisitDate = visitPast5, FollowUpDate = null, Status = "Completed", Pet = pets[19], Veterinarian = veterinarians[0], CreatedAt = seedDate, UpdatedAt = seedDate },
                
                // Pelusa (pets[20]) - Poodle Blanco
                new MedicalHistory { Diagnosis = "Control de cachorra - Revisión integral", Notes = "Cachorra sana. Crecimiento adecuado. vacunación iniciada.", VisitDate = visitPast95, FollowUpDate = visitPast85, Status = "Completed", Pet = pets[20], Veterinarian = veterinarians[0], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "Serie de vacunación primaria completada", Notes = "Tercera dosis DHPP aplicada. Protección completa alcanzada.", VisitDate = visitPast75, FollowUpDate = null, Status = "Completed", Pet = pets[20], Veterinarian = veterinarians[1], CreatedAt = seedDate, UpdatedAt = seedDate },
                ...
                new MedicalHistory { Diagnosis = "Limpieza dental y Revisión oral", Notes = "Sarro presente. Detartraje recomendado. Higiene dental pobre.", VisitDate = visitPast42, FollowUpDate = followUpFuture90, Status = "Completed", Pet = pets[21], Veterinarian = veterinarians[1], CreatedAt = seedDate, UpdatedAt = seedDate },
                new MedicalHistory { Diagnosis = "vacunación anual de refuerzo", Notes = "DHPP y antirrábica aplicadas. Historial de vacuna al día.", VisitDate = visitPast60, FollowUpDate = null, Status = "Completed", Pet = pets[21], Veterinarian = veterinarians[0], CreatedAt = seedDate, UpdatedAt = seedDate }
            };
